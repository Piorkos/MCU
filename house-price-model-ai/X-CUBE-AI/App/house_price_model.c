/**
  ******************************************************************************
  * @file    house_price_model.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Fri Mar 26 09:01:59 2021
...
#define AI_NET_OBJ_INSTANCE g_house_price_model
 
#undef AI_HOUSE_PRICE_MODEL_MODEL_SIGNATURE
#define AI_HOUSE_PRICE_MODEL_MODEL_SIGNATURE     "c44efb04febc78d7a770cde60b9132e2"
...
#define AI_TOOLS_DATE_TIME   "Fri Mar 26 09:01:59 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_HOUSE_PRICE_MODEL_N_BATCHES
#define AI_HOUSE_PRICE_MODEL_N_BATCHES         (1)
...
AI_STATIC ai_array dense_10_bias_array;   /* Array #0 */
AI_STATIC ai_array dense_10_weights_array;   /* Array #1 */
AI_STATIC ai_array dense_9_bias_array;   /* Array #2 */
AI_STATIC ai_array dense_9_weights_array;   /* Array #3 */
AI_STATIC ai_array dense_8_bias_array;   /* Array #4 */
AI_STATIC ai_array dense_8_weights_array;   /* Array #5 */
AI_STATIC ai_array dense_7_bias_array;   /* Array #6 */
AI_STATIC ai_array dense_7_weights_array;   /* Array #7 */
AI_STATIC ai_array dense_6_bias_array;   /* Array #8 */
AI_STATIC ai_array dense_6_weights_array;   /* Array #9 */
AI_STATIC ai_array dense_5_bias_array;   /* Array #10 */
AI_STATIC ai_array dense_5_weights_array;   /* Array #11 */
AI_STATIC ai_array dense_4_bias_array;   /* Array #12 */
AI_STATIC ai_array dense_4_weights_array;   /* Array #13 */
AI_STATIC ai_array dense_3_bias_array;   /* Array #14 */
AI_STATIC ai_array dense_3_weights_array;   /* Array #15 */
AI_STATIC ai_array dense_2_bias_array;   /* Array #16 */
AI_STATIC ai_array dense_2_weights_array;   /* Array #17 */
AI_STATIC ai_array dense_1_bias_array;   /* Array #18 */
AI_STATIC ai_array dense_1_weights_array;   /* Array #19 */
AI_STATIC ai_array dense_0_bias_array;   /* Array #20 */
AI_STATIC ai_array dense_0_weights_array;   /* Array #21 */
AI_STATIC ai_array dense_73_input_output_array;   /* Array #22 */
AI_STATIC ai_array dense_0_output_array;   /* Array #23 */
AI_STATIC ai_array nl_0_output_array;   /* Array #24 */
AI_STATIC ai_array dense_1_output_array;   /* Array #25 */
AI_STATIC ai_array nl_1_output_array;   /* Array #26 */
AI_STATIC ai_array dense_2_output_array;   /* Array #27 */
AI_STATIC ai_array nl_2_output_array;   /* Array #28 */
AI_STATIC ai_array dense_3_output_array;   /* Array #29 */
AI_STATIC ai_array nl_3_output_array;   /* Array #30 */
AI_STATIC ai_array dense_4_output_array;   /* Array #31 */
AI_STATIC ai_array nl_4_output_array;   /* Array #32 */
AI_STATIC ai_array dense_5_output_array;   /* Array #33 */
AI_STATIC ai_array nl_5_output_array;   /* Array #34 */
AI_STATIC ai_array dense_6_output_array;   /* Array #35 */
AI_STATIC ai_array nl_6_output_array;   /* Array #36 */
AI_STATIC ai_array dense_7_output_array;   /* Array #37 */
AI_STATIC ai_array nl_7_output_array;   /* Array #38 */
AI_STATIC ai_array dense_8_output_array;   /* Array #39 */
AI_STATIC ai_array nl_8_output_array;   /* Array #40 */
AI_STATIC ai_array dense_9_output_array;   /* Array #41 */
AI_STATIC ai_array nl_9_output_array;   /* Array #42 */
AI_STATIC ai_array dense_10_output_array;   /* Array #43 */
AI_STATIC ai_array nl_10_output_array;   /* Array #44 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor dense_10_bias;   /* Tensor #0 */
AI_STATIC ai_tensor dense_10_weights;   /* Tensor #1 */
AI_STATIC ai_tensor dense_9_bias;   /* Tensor #2 */
AI_STATIC ai_tensor dense_9_weights;   /* Tensor #3 */
AI_STATIC ai_tensor dense_8_bias;   /* Tensor #4 */
AI_STATIC ai_tensor dense_8_weights;   /* Tensor #5 */
AI_STATIC ai_tensor dense_7_bias;   /* Tensor #6 */
AI_STATIC ai_tensor dense_7_weights;   /* Tensor #7 */
AI_STATIC ai_tensor dense_6_bias;   /* Tensor #8 */
AI_STATIC ai_tensor dense_6_weights;   /* Tensor #9 */
AI_STATIC ai_tensor dense_5_bias;   /* Tensor #10 */
AI_STATIC ai_tensor dense_5_weights;   /* Tensor #11 */
AI_STATIC ai_tensor dense_4_bias;   /* Tensor #12 */
AI_STATIC ai_tensor dense_4_weights;   /* Tensor #13 */
AI_STATIC ai_tensor dense_3_bias;   /* Tensor #14 */
AI_STATIC ai_tensor dense_3_weights;   /* Tensor #15 */
AI_STATIC ai_tensor dense_2_bias;   /* Tensor #16 */
AI_STATIC ai_tensor dense_2_weights;   /* Tensor #17 */
AI_STATIC ai_tensor dense_1_bias;   /* Tensor #18 */
AI_STATIC ai_tensor dense_1_weights;   /* Tensor #19 */
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #20 */
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #21 */
AI_STATIC ai_tensor dense_73_input_output;   /* Tensor #22 */
AI_STATIC ai_tensor dense_0_output;   /* Tensor #23 */
AI_STATIC ai_tensor nl_0_output;   /* Tensor #24 */
AI_STATIC ai_tensor dense_1_output;   /* Tensor #25 */
AI_STATIC ai_tensor nl_1_output;   /* Tensor #26 */
AI_STATIC ai_tensor dense_2_output;   /* Tensor #27 */
AI_STATIC ai_tensor nl_2_output;   /* Tensor #28 */
AI_STATIC ai_tensor dense_3_output;   /* Tensor #29 */
AI_STATIC ai_tensor nl_3_output;   /* Tensor #30 */
AI_STATIC ai_tensor dense_4_output;   /* Tensor #31 */
AI_STATIC ai_tensor nl_4_output;   /* Tensor #32 */
AI_STATIC ai_tensor dense_5_output;   /* Tensor #33 */
AI_STATIC ai_tensor nl_5_output;   /* Tensor #34 */
AI_STATIC ai_tensor dense_6_output;   /* Tensor #35 */
AI_STATIC ai_tensor nl_6_output;   /* Tensor #36 */
AI_STATIC ai_tensor dense_7_output;   /* Tensor #37 */
AI_STATIC ai_tensor nl_7_output;   /* Tensor #38 */
AI_STATIC ai_tensor dense_8_output;   /* Tensor #39 */
AI_STATIC ai_tensor nl_8_output;   /* Tensor #40 */
AI_STATIC ai_tensor dense_9_output;   /* Tensor #41 */
AI_STATIC ai_tensor nl_9_output;   /* Tensor #42 */
AI_STATIC ai_tensor dense_10_output;   /* Tensor #43 */
AI_STATIC ai_tensor nl_10_output;   /* Tensor #44 */
...
AI_STATIC_CONST ai_tensor_chain nl_5_chain;   /* Chain #11 */
AI_STATIC_CONST ai_tensor_chain dense_6_chain;   /* Chain #12 */
AI_STATIC_CONST ai_tensor_chain nl_6_chain;   /* Chain #13 */
AI_STATIC_CONST ai_tensor_chain dense_7_chain;   /* Chain #14 */
AI_STATIC_CONST ai_tensor_chain nl_7_chain;   /* Chain #15 */
AI_STATIC_CONST ai_tensor_chain dense_8_chain;   /* Chain #16 */
AI_STATIC_CONST ai_tensor_chain nl_8_chain;   /* Chain #17 */
AI_STATIC_CONST ai_tensor_chain dense_9_chain;   /* Chain #18 */
AI_STATIC_CONST ai_tensor_chain nl_9_chain;   /* Chain #19 */
AI_STATIC_CONST ai_tensor_chain dense_10_chain;   /* Chain #20 */
AI_STATIC_CONST ai_tensor_chain nl_10_chain;   /* Chain #21 */
...
AI_STATIC ai_layer_nl nl_5_layer; /* Layer #11 */
AI_STATIC ai_layer_dense dense_6_layer; /* Layer #12 */
AI_STATIC ai_layer_nl nl_6_layer; /* Layer #13 */
AI_STATIC ai_layer_dense dense_7_layer; /* Layer #14 */
AI_STATIC ai_layer_nl nl_7_layer; /* Layer #15 */
AI_STATIC ai_layer_dense dense_8_layer; /* Layer #16 */
AI_STATIC ai_layer_nl nl_8_layer; /* Layer #17 */
AI_STATIC ai_layer_dense dense_9_layer; /* Layer #18 */
AI_STATIC ai_layer_nl nl_9_layer; /* Layer #19 */
AI_STATIC ai_layer_dense dense_10_layer; /* Layer #20 */
AI_STATIC ai_layer_nl nl_10_layer; /* Layer #21 */
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 304, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HOUSE_PRICE_MODEL_IN_NUM, &dense_73_input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_HOUSE_PRICE_MODEL_OUT_NUM, &nl_10_output),
...
AI_API_ENTRY
ai_bool ai_house_price_model_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_HOUSE_PRICE_MODEL_MODEL_NAME,
      .model_signature   = AI_HOUSE_PRICE_MODEL_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_house_price_model_get_error(ai_handle network)
{
...
AI_API_ENTRY
ai_handle ai_house_price_model_destroy(ai_handle network)
{
...
AI_API_ENTRY
ai_i32 ai_house_price_model_forward(ai_handle network, const ai_buffer* input)
{
