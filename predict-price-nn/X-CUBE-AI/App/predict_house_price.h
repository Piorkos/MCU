...
#ifndef AI_PREDICT_HOUSE_PRICE_H
#define AI_PREDICT_HOUSE_PRICE_H
#pragma once

#include "predict_house_price_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_PREDICT_HOUSE_PRICE_MODEL_NAME          "predict_house_price"
#define AI_PREDICT_HOUSE_PRICE_ORIGIN_MODEL_NAME   "house_price_model_no_quant"

/******************************************************************************/
#define AI_PREDICT_HOUSE_PRICE_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_PREDICT_HOUSE_PRICE_IN_NUM        (1)
#define AI_PREDICT_HOUSE_PRICE_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 19, 1, NULL), \
}
#define AI_PREDICT_HOUSE_PRICE_IN_SIZE { \
  AI_PREDICT_HOUSE_PRICE_IN_1_SIZE, \
}
#define AI_PREDICT_HOUSE_PRICE_IN_SIZE_BYTES { \
  AI_PREDICT_HOUSE_PRICE_IN_1_SIZE_BYTES, \
}
#define AI_PREDICT_HOUSE_PRICE_IN_1_HEIGHT      (1)
#define AI_PREDICT_HOUSE_PRICE_IN_1_WIDTH       (1)
#define AI_PREDICT_HOUSE_PRICE_IN_1_CHANNEL     (19)
#define AI_PREDICT_HOUSE_PRICE_IN_1_SIZE        (1 * 1 * 19)
#define AI_PREDICT_HOUSE_PRICE_IN_1_SIZE_BYTES  (AI_PREDICT_HOUSE_PRICE_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_PREDICT_HOUSE_PRICE_OUT_NUM       (1)
#define AI_PREDICT_HOUSE_PRICE_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_PREDICT_HOUSE_PRICE_OUT_SIZE { \
  AI_PREDICT_HOUSE_PRICE_OUT_1_SIZE, \
}
#define AI_PREDICT_HOUSE_PRICE_OUT_SIZE_BYTES { \
  AI_PREDICT_HOUSE_PRICE_OUT_1_SIZE_BYTES, \
}
#define AI_PREDICT_HOUSE_PRICE_OUT_1_HEIGHT      (1)
#define AI_PREDICT_HOUSE_PRICE_OUT_1_WIDTH       (1)
#define AI_PREDICT_HOUSE_PRICE_OUT_1_CHANNEL     (1)
#define AI_PREDICT_HOUSE_PRICE_OUT_1_SIZE        (1 * 1 * 1)
#define AI_PREDICT_HOUSE_PRICE_OUT_1_SIZE_BYTES  (AI_PREDICT_HOUSE_PRICE_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_PREDICT_HOUSE_PRICE_N_NODES (22)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup predict_house_price
 ...
 * @ref ai_predict_house_price_create. Both the activations memory buffer 
 ...
 * using @ref ai_predict_house_price_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_PREDICT_HOUSE_PRICE_*
 * defines into file @ref predict_house_price.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_predict_house_price_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_PREDICT_HOUSE_PRICE_H */
